...
import { ILoginState, LoginStatus } from '@Store';
import { BlacksuitAppAction } from '@actions/BlacksuitAppAction';
import { LoginActions } from '@actions/LoginActions';
import authenticationConfig from '@config/AuthenticationConfig';

export const INITIAL_LOGIN_STATE: ILoginState = {
...
const loginState = (state: ILoginState = INITIAL_LOGIN_STATE, action: BlacksuitAppAction): ILoginState => {
  switch (action.type) {
